...
// What is `math` set to?
math = high - "5";
// A: 50"5" wrong. returns 45. 505 would be using a + for concatenating. this is seeing that "5" has a number in the string and dose math with that.
...
// A: False gahh its true. (-5(truthy) && 5(truthy)) both are truthy.
...
// A: false answer is true {} is creating an object so the if() sees an object inside it and if true.
